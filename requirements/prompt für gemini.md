# Erstelle fÃ¼r eine SQLITE3 Datenabnke eine Streamlit App_
...
## Tabelle mit den AktivitÃ¤ten der Nutzer
...
## Filter auf DatensÃ¤tze

bitte nur fÃ¼r DatensÃ¤tze mit userid = 1 umsetzen.



## Text to Requirements

Bitte parse die beiden Bilder, denn sie enhalten eine Web Applikation, die mit PHP realisiet worden ist
